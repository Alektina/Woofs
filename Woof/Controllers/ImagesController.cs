...
namespace Woof.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImageID,ImageName,ImagePath")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageID,ImageName,ImagePath")] Image image)
        {
            if (id != image.ImageID)
            {
                return NotFound();
