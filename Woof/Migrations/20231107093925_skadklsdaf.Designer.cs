...
namespace Woof.Migrations
{
    ...
    [Migration("20231107093925_skadklsdaf")]
    partial class skadklsdaf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Woof.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@admin",
                            Password = "admin",
                            RegistrationDate = new DateTime(2023, 11, 7, 10, 39, 25, 629, DateTimeKind.Local).AddTicks(9089),
                            RoleID = 4,
                            Username = "Admin"
                        },
                        new
                        {
                            ...
                            Email = "bronze@bronze",
                            Password = "bronze",
                            RegistrationDate = new DateTime(2023, 11, 7, 10, 39, 25, 629, DateTimeKind.Local).AddTicks(9128),
                            RoleID = 1,
                            Username = "Bronze"
                        },
                        new
                        {
                            ...
                            Email = "silver@silver",
                            Password = "silver",
                            RegistrationDate = new DateTime(2023, 11, 7, 10, 39, 25, 629, DateTimeKind.Local).AddTicks(9134),
                            RoleID = 2,
                            Username = "Silver"
                        },
                        new
                        {
                            ...
                            Email = "gold@gold",
                            Password = "gold",
                            RegistrationDate = new DateTime(2023, 11, 7, 10, 39, 25, 629, DateTimeKind.Local).AddTicks(9139),
                            RoleID = 3,
                            Username = "Gold"
                        });
                });
