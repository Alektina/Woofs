...
namespace Woof.Migrations
{
    ...
    [Migration("20231106152357_PremadeTables")]
    partial class PremadeTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Woof.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@admin",
                            Password = "admin",
                            RegistrationDate = new DateTime(2023, 11, 6, 16, 23, 57, 721, DateTimeKind.Local).AddTicks(665),
                            RoleID = 4,
                            Username = "Admin"
                        },
                        new
                        {
                            ...
                            Email = "bronze@bronze",
                            Password = "bronze",
                            RegistrationDate = new DateTime(2023, 11, 6, 16, 23, 57, 721, DateTimeKind.Local).AddTicks(701),
                            RoleID = 1,
                            Username = "Bronze"
                        },
                        new
                        {
                            ...
                            Email = "silver@silver",
                            Password = "silver",
                            RegistrationDate = new DateTime(2023, 11, 6, 16, 23, 57, 721, DateTimeKind.Local).AddTicks(707),
                            RoleID = 2,
                            Username = "Silver"
                        },
                        new
                        {
                            ...
                            Email = "gold@gold",
                            Password = "gold",
                            RegistrationDate = new DateTime(2023, 11, 6, 16, 23, 57, 721, DateTimeKind.Local).AddTicks(712),
                            RoleID = 3,
                            Username = "Gold"
                        });
                });
